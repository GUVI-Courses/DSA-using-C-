...
int main() {
    ...
    hashTableChaining.insert(35);
    hashTableChaining.insert(38);
    ...
    hashTableLinear.insert(35);
    hashTableLinear.insert(38);
    ...
    hashTableQuadratic.insert(35);
    hashTableQuadratic.insert(38);
